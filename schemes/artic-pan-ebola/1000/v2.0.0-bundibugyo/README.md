# artic-pan-ebola 1000bp v2.0.0-bundibugyo

![Generic badge](https://img.shields.io/badge/STATUS-TESTED-blue.svg)

## Notes

This is the artic-pan-ebola/1000/v2.0.0 primer scheme remapped to a bundibugyo genome
...
```json
{
    ...
    "amplicon_size": 1000,
    "primer_scheme_version": "v2.0.0-bundibugyo",
    "primer_scheme_identifier": "artic-pan-ebola/1000/v2.0.0-bundibugyo",
